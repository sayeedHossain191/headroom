            ...
            <footer className="footer p-10 bg-base-200 text-base-content mt-28 font-lato">
                <nav>
                    ...
                    <a className="link link-hover">2728 Hickory StreetSalt
                        Lake City, UT 84104</a>
                    <a className="link link-hover flex items-center gap-1"><FaPhone />+1 206-214-2298</a>
                    <a className="link link-hover flex items-center gap-1"><AiOutlineMail />support@rezilla.com</a>
